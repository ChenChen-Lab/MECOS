...
open (OUT, ">$outdir/metaspades_assembly.sh")||die;
...
#         chomp($num);
	...
	close OUT1;
	close Config;
	`perl $Bin/dsub_batch2.pl -thd 10 -mem 4 $outdir/metaspades_assembly.sh`;

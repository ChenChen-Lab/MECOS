...
use vars qw( $file_first $file_second $seperator_connect $debug $top_num $append_string);
...
sub usage
{
    ...
    print "Usage:\n\n";
    print "$0 [-d] [-F 1,2] [-f 1,2] [-S \"\\t\"] [-s \"\\t\"] [-c \"\\t\"] [-N num] [-x appendstring] [-t topnum] [-o \"\\t\"] <-a file1> <-b file2>\n";
    print "  d: debug mode\n";
    ...
    print "  x: append string for lost data, default '*-*'\n";
